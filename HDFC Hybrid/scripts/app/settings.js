...
var appSettings = {
    ...
    everlive: {
        apiKey: 'QHQnRgcMizKsvkur', // Put your Backend Services API key here
        scheme: 'http',
        url: ''
    },

    eqatec: {
        productKey: '5ce1ace9a1da4feda3c292c8c24a345b',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    feedback: {
        apiKey: '76fbdc00-0a10-11e5-adfe-a7c92ddc635b',  // Put your AppFeedback API key here
        options: {
            enableShake: true,
